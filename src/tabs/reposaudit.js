  ...
  render() {
      return (
        <tr key={this.props.repo.name}>
          <td className="vmid"><NavLink to={"/repos/audit/"+this.props.repo.facility+"/"+this.props.repo.name}>{this.props.repo.name}</NavLink></td>
...
export default function ReposAuditListView() {
